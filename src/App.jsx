...
useEffect(() => {
  ...
  axios.get("http://localhost:3003/scooters/countKm")
      .then((response) => {
        console.log(response.data);
...
const sort = by => {
  ...
  return (
    <>
    <div className="App">
      <Header sort={sort} scooterCount={scooterCount} scooterKm={scooterKm}></Header>
    ...
    <Modal id={modalId} scooter={getScooter(modalId)} editPaspirtukas={editPaspirtukas} hideModal={hideModal}></Modal>
